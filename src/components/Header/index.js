      ...
      <nav className="bg-cyan-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <h1 className="bg-cyan-600 text-xl text-white text-center">
              Cleve's Portfolio
            </h1>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="bg-cyan-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
